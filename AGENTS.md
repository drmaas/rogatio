...
- `packages/schema` — version-2 JSON Schema (draft 2020-12, `additionalProperties: false`), AJV validation, source conditions (`url`|`host` + regex), bounds, forbidden-header lists, semantic validation, v1→v2 migration. No actions, no consumers.
