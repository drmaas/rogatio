...
- [x] Stage 3 — specification: `docs/specs/f24-group-activation-visibility.md` (`REQ-GAV-001`..`009`, `AC-GAV-001`..`005`; `(b2)`; byte-identical duplicate `f-group-activation-visibility.md` collapsed at the 2026-08-31 reconciliation)
- [x] Stage 4 — user approval confirmed (`b1`, `b2`)
- [x] Stage 5 — implementation plan: `docs/plans/f24-group-activation-visibility.md` (`T1`..`T5` mapped to AC IDs; `(b2)`; byte-identical duplicate `f-group-activation-visibility.md` collapsed at the 2026-08-31 reconciliation)
