...
the Chrome match event, plus the **intended** redirect destination, query transform, or
header operation from your rule config. It reports a **match** and **intended action** — not
